...
export default function ProjectsPortfolio({ onSelectProject, onOpenInquiry }: ProjectsPortfolioProps) {
  ...
  return (
    <section id="projects" className="py-20 lg:py-28 bg-[#070D18] relative border-t border-slate-800/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 space-y-3">
          ...
          <div className="text-xs sm:text-sm text-[#E06D14] font-mono-tech uppercase tracking-wide">
            Industrial & Infrastructure | Government & Public Works | Power & Utilities | Commercial & Hospitality | Special Structures & Rehabilitation
          </div>
